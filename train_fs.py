...
@click.command()
# basic_kwargs.
@click.option('--outdir',    help='Where to save the results', metavar='DIR',   default='/mnt/lustre/gongjunchao/IF_WKP',type=str)
...
# training_set_kwargs
@click.option('--dataset',   help='Dataset class',                              default='ERA5GDataset',         type=str) #'ERA5GDataset'
@click.option('--dir_data',  help='Path of training data',                      default='/mnt/lustre/share_data/ai4earth/era5G32x64_new',         type=str) #'/mnt/lustre/share_data/ai4earth/era5G32x64'
...
def main(**kwargs):
    ...
    c.scheduler_kwargs.decay_rate = opts.decay_rate
